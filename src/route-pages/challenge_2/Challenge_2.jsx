                        ...
                        <div className="w-full max-w-md space-y-8">
                            <form className="mt-8 space-y-6" action="#" method="POST">
                                ...
                                <div className="-space-y-px rounded-md shadow-sm">
                                    <div>
                                        <label htmlFor="name" className="">Card holder name</label>
                                        <input id="name" name="name" type="text" autoComplete="name" value={cardInfo.name} required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="e.g. Jane Appleseed" onInput={(e) => { e.target.value.length < 17 && setCardInfo({ ...cardInfo, name: e.target.value }) }} />
                                    </div>
                                    <div>
                                        <label htmlFor="card-number" className="">Card number</label>
                                        <input id="card-number" name="card-number" type="number" autoComplete="number" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="e.g. 1234 5678 9123 0000" onWheel={(e) => { e.target.blur() }} value={cardInfo.number} onInput={(e) => { e.target.value.length < 17 && setCardInfo({ ...cardInfo, number: e.target.value }) }} />
                                    </div>
                                    <div>
                                        <label htmlFor="password" className="">EXP. DATE (MM/YY)</label>
                                        <input id="card-number" name="card-number" type="number" autoComplete="number" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="MM" onWheel={(e) => { e.target.blur() }} value={cardInfo.expiryM} onInput={(e) => { e.target.value.length < 3 && e.target.value < 13 && setCardInfo({ ...cardInfo, expiryM: e.target.value }) }} />
                                        <input id="card-number" name="card-number" type="number" autoComplete="number" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="YY" onWheel={(e) => { e.target.blur() }} value={cardInfo.expiryY} onInput={(e) => { e.target.value.length < 3 && setCardInfo({ ...cardInfo, expiryY: e.target.value }) }} />
                                        <input id="card-number" name="card-number" type="number" autoComplete="number" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="CVV" onWheel={(e) => { e.target.blur() }} value={cardInfo.cvv} onInput={(e) => { e.target.value.length < 4 && setCardInfo({ ...cardInfo, cvv: e.target.value }) }} />
