            ...
            <div className=" bg-[#f5eadd] w-screen min-h-screen flex items-center">
                <div className="container mx-auto">
                    <div className="flex max-w-5xl flex-wrap justify-center m-auto">
                        <div className="w-full p-4 sm:p-7 flex sm:w-3/4 md:w-3/4 lg:w-[60vw] xl:w-1/2 max-w-5xl overflow-hidden bg-[#ec775f] rounded-2xl shadow-xl m-3">
                        ...
                        <div className="w-full p-4 sm:p-7 sm:w-3/4 md:w-3/4 lg:w-[60vw] xl:w-1/2 overflow-hidden bg-white rounded-2xl shadow-xl m-3">
                            <h2 className='text-3xl text-amber-900 font-semibold'>Spending - Last 7 days</h2>
                            <BarChart d={data} />
                        </div>
                    </div>
                </div>
